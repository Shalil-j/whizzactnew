    <!-- navbar -->
    <nav class="navbar navbar-expand-lg shadow-0 position-fixed w-100">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            <div>
                <a href="index.html">
                    <img src="./asserts/logo.png" alt="" style="width: 5rem;">
                </a>
            </div>
            <div class="d-none d-lg-block">
            <ul class="navbar nav border-0 shadow-0 ">
                <li class="nav-item">
                    <a class="nav-link text-white links" href="index.html">Home</a>
                </li>
                <li class="nav-item dropdown position-static">
                  <a class="nav-link text-white service-link  dropdown-toggle fw-semibold" href="#" id="navbarDropdown" role="button"
                    data-mdb-toggle="dropdown" aria-expanded="false">
                    Services
                  </a>
                  <!-- Dropdown menu -->
                  <div class="dropdown-menu mt-0 border-0" aria-labelledby="navbarDropdown" style="
                  ...
                  <div class="container row p-3 ">
                    <div class="col-3  border-end p-3">
                      <a href="" class="page-link dd-link">
                      <h5 class="dropd-links">Mobile Application</h5>
                      <ul class="list-group list-group-flush mt-2 dd-list">
                        <li class="list-group-item text-secondary">Andriod</li>
                        <li class="list-group-item text-secondary">iOS</li>
                        <li class="list-group-item text-secondary">Hybrid</li>
                        <li class="list-group-item text-secondary">PWD</li>
                      </ul></a>
                    </div>
                    <div class="col-3  border-end p-3">
                      <a href="" class="page-link dd-link">
                        <h5 class="dropd-links">Web Application</h5>
                        <ul class="list-group list-group-flush mt-2 dd-list">
                          <li class="list-group-item text-secondary">Enterpise Solutions</li>
                              <li class="list-group-item text-secondary">CMS</li>
                              <li class="list-group-item text-secondary">APi & Backend</li>
                              <li class="list-group-item text-secondary">Custom Development</li>
                        </ul></a>
                    </div>
                    <div class="col-3  border-end p-3">
                      <a href="" class="page-link dd-link">
                        <h5 class="dropd-links">DeveOps Service</h5>
                        <ul class="list-group list-group-flush mt-2 dd-list">
                          <li class="list-group-item text-secondary">SetUp</li>
                              <li class="list-group-item text-secondary">Automation</li>
                              <li class="list-group-item text-secondary">Continous Delivery</li>
                              <li class="list-group-item text-secondary">Monitoring</li>
                        </ul></a>
                    </div>
                    <div class="col-3 px-3 d-flex flex-column justify-content-around">
                      <a class=" dropd-links " href="">Cloud Computing</a>
                      <a class=" dropd-links " href="">Deveops Service</a>
                      <a class=" dropd-links " href="">Internet Marketing</a>
                      <a class=" dropd-links " href="">Graphic Desigining</a>
                      <a class=" dropd-links " href="">Ux/Ui Desigining</a>
                    
                  </div>
                </div>

                  <div class="w-100 p-2 border-top border-2">
                    <p class="text-center fw-semibold text-secondary">Tools</p>
                    <div class="d-flex justify-content-between px-5  tools py-2">
                  ...
                  <li class="nav-item">
                    <a class="nav-link text-white links " href="whyWhizzact.html">Why WhizzAct</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white  links " href="industry.html">Industry</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white links " href="company.html">Company</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white links " href="contact.html">Contact</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link  fw-bold portfolio rounded-9" href="">Our PortFolio</a>
                </li>                                                  
            </ul>
        </div>
        <!-- side bar -->
        <button class="navbar-toggler d-lg-none btn shadow-0 border-0" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDarkNavbar" aria-controls="offcanvasDarkNavbar">
          <i class="bi bi-list" style="color: #3419AB;"></i>
        </button>
        <div  class="offcanvas offcanvas-end text-bg-dark d-lg-none" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
          <div  class="offcanvas-header bg-white ">
            <img src="./asserts/logo.png" alt=""  class="w-25">
            <button type="button" class="btn-close btn-close-dark" data-bs-dismiss="offcanvas" aria-label="Close"></button>
          </div>
          <div class="offcanvas-body bg-white border-top" >
            <ul class="navbar-nav justify-content-center flex-grow-1 mx-auto">
              <li class="nav-item  px-3 rounded">
                <a class="nav-link active  sidebar-links fw-bold" aria-current="page" href="index.html">Home</a>
              </li>

              <li class="dropdown  rounded">
                <a
                  class="ps-3 mt-1 fw-bold btn  dropdown-toggle shadow-0 w-100 text-start nav-link"
                  href="#"
                  role="button"
                  id="dropdownMenuLink"
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  <div class="row justify-content-center">
                    <div class="col-10 border-bottom py-2">
                      <a href="" class="d-flex nav-link side-navlink">
                        <span class="material-symbols-outlined">
                          phone_iphone
                          </span>
                      <p class="ms-2">Mobile Application</p>
                    </a>
                    </div>
                    <!-- ----- -->
                    <div class="col-10 border-bottom py-2">
                      ...
                      <p class="ms-2">Web Application</p>
                    </a>
                    </div>
                    <!-- ----- -->
                    <div class="col-10 border-bottom py-2">
                      ...
                      <p class="ms-2">Software Developmen</p>
                    </a>
                    </div>
                    <!-- ----- -->
                    <div class="col-10 border-bottom py-2">
                    ...
                    <div class="col-10 border-bottom py-2">
                      ...
                      <p class="ms-2">Cloud Computing</p>
                    </a>
                    </div>
                    <!-- ----- -->
                    <div class="col-10 border-bottom py-2">
                      ...
                      <p class="ms-2">Internet Marketing</p>
                    </a>
                    </div>
                    <!-- ----- -->
                    <div class="col-10 border-bottom py-2">
                      ...
                      <p class="ms-2">Graphic Designing</p>
                    </a>
                    </div>
                    <!-- ----- -->
                    <div class="col-10  py-2">
                      ...
                      <p class="ms-2">UX/UI Designing</p>
                    </a>
                    </div>
                    <!-- ----- -->
              ...
              <li class="nav-item  px-3 rounded mt-3">
                <a class="nav-link active  sidebar-links fw-bold" aria-current="page" href="whyWhizzact.html">Why WhizzAct</a>
              </li>
              <li class="nav-item  px-3 rounded mt-3">
                <a class="nav-link active  sidebar-links fw-bold" aria-current="page" href="industry.html">Industry</a>
              </li>
              <li class="nav-item  px-3 rounded mt-3">
                <a class="nav-link active  sidebar-links fw-bold" aria-current="page" href="company.html">Company</a>
              </li>
              <li class="nav-item  px-3 rounded mt-3">
                <a class="nav-link active  sidebar-links fw-bold" aria-current="page" href="contact.html">Contact</a>
              </li>
              <button class="btn btn-primary mt-5 fw-bold">Out PortFolio</button> 
